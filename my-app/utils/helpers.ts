...
const api_url =
  "https://nutritious-lisbeth-testingxyz-5f3d2a31.koyeb.app/graphql";

const gql_client = new GraphQLClient(api_url, {});
...
const handleFileUpload = async (
  ...
  try {
    ...
    const res = await fetch(
      `https://nutritious-lisbeth-testingxyz-5f3d2a31.koyeb.app/api/v1/upload`,
      {
        method: "POST",
        headers: {
