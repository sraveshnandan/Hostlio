    ...
    <AuthContainer>
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <InputBox
          ...
          onChange={(value) =>
            setRegistrationPayload((prev) => ({ ...prev, first_name: value }))
          }
        />
        ...
        <InputBox
          ...
          onChange={(value) =>
            setRegistrationPayload((prev) => ({ ...prev, last_name: value }))
          }
        />
        ...
        <InputBox
          ...
          onChange={(value) =>
            setRegistrationPayload((prev) => ({ ...prev, email: value }))
          }
        />
        ...
        <InputBox
          ...
          onChange={(value) =>
            setRegistrationPayload((prev) => ({ ...prev, password: value }))
          }
        />
